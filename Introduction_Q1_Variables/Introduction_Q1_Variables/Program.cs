...
double game_currency;
game_currency = 2500.50;
Console.WriteLine("game curreny: "+ game_currency);
// string variable
...
bool isaLive;
isaLive = true;
Console.WriteLine("player is live? "+isaLive);
// char variable
...
char patrol_state;
patrol_state = 's';
Console.WriteLine("state"+ patrol_state);
// Byte variable
...
byte player_age;
player_age = 25;
Console.WriteLine("age: "+ player_age);
// Long variable
...
null_variable = null;
Console.WriteLine("variable: "+ null_variable);
// Float variable
...
Console.WriteLine("max reitries: "+ MaxRetries);
...
Console.WriteLine("have {0} months in year",MonthsInYear);
Console.ReadKey();
